...
namespace KillfaceTools.FMO
{
	...
	public class FloatMenuOptionNoClose : FloatMenuOption
	{
		...
		public FloatMenuOptionNoClose(string label, Action action, float extraPartWidth, Func<Rect, bool> extraPartOnGUI = null) : base(label, action, MenuOptionPriority.Default, null, null, extraPartWidth, extraPartOnGUI, null)
		{
		}
